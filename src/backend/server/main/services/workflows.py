...
class Workflows:
    ...
    def update_workflows(
        jwt: str, action: str, message: list, project_id: str, item_id: str
    ):
        """
    ...
    def get_workflows(
        self, customer_id: str, project_id: str, type_id: str, actions: list
    ):
        """
        ...
        key = {"index_name": "typeId", "index_val": type_id}
        ...
        workflows, http_status_code = self._db.read_multiple_items(
