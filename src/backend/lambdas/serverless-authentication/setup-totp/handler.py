...
def setup_totp(session_token: str, secret_code: str = "", mfa_code: str = ""):
    ...
    if session_token and not secret_code and not mfa_code:
        ...
        return {"sessionToken": response["Session"], "secretCode": response["SecretCode"]}, response['ResponseMetadata']['HTTPStatusCode']
    ...
    return {"status":response["Status"], "sessionToken": response["Session"], "response":response}, response['ResponseMetadata']['HTTPStatusCode']
