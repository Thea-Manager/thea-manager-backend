...
setuptools.setup(
    ...
    install_requires=[
        ...
        "aws_cdk.aws_autoscaling==1.115.0",
        "aws_cdk.aws_cloudfront==1.115.0",
        "aws_cdk.aws_cloudfront_origins==1.115.0",
        "aws_cdk.aws_dynamodb==1.115.0",
        "aws_cdk.aws_ec2==1.115.0",
        "aws_cdk.aws_elasticloadbalancingv2",
        "aws_cdk.aws_elasticloadbalancingv2==1.115.0",
        "aws_cdk.aws_elasticloadbalancingv2==1.115.0",
        "aws_cdk.aws_iam==1.115.0",
        "aws_cdk.aws_s3==1.115.0",
        "aws_cdk.aws_eks==1.115.0",
        "aws_cdk.aws_ecs==1.115.0",
        "aws_cdk.aws_ecs_patterns==1.115.0",
        "aws_cdk.aws_ecr==1.115.0",
        # "aws_cdk.aws_eks.KubernetesVersion==1.115.0"
    ],
