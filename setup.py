...
setuptools.setup(
    ...
    install_requires=[
        ...
        "aws-cdk.aws-apigatewayv2-integrations==1.114.0",
        ...
        "aws_cdk.aws_autoscaling==1.114.0",
        "aws_cdk.aws_cloudfront==1.114.0",
        "aws_cdk.aws_cloudfront_origins==1.114.0",
        "aws_cdk.aws_dynamodb==1.114.0",
        "aws_cdk.aws_ec2==1.114.0",
        "aws_cdk.aws_elasticloadbalancingv2",
        "aws_cdk.aws_elasticloadbalancingv2==1.114.0",
        "aws_cdk.aws_elasticloadbalancingv2==1.114.0",
        "aws_cdk.aws_iam==1.114.0",
        "aws_cdk.aws_s3==1.114.0"
    ],
