...
class ProjectsManager():
    ...
    def get_project_overview(self, customer_id: str, last_evaluated_key: str = None):
        ...
        return self._db.read_multiple_items(table_name, key, projection_expression, expression_attribute_names, last_evaluated_key)
